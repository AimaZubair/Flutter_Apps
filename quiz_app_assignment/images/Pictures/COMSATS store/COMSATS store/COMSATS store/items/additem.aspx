        ...
        <div id="errormsg" runat="server">
            <table style="width:100%; text-align:left; margin-top:30px">
                 <tr>
                    ...
                    <td class="scol">
                        <input id ="datepicker"  runat="server" style="width:270px" required />
                    </td>
                </tr>
                 <tr>
                ...
                <td class="scol">
                <asp:DropDownList ID="category" runat="server" class="form-form" style="width:270px;height:40px" OnSelectedIndexChanged="category_SelectedIndexChanged" AutoPostBack="true" required></asp:DropDownList>
            ...
            <div style="width:100%; text-align:center; height:60px; margin-top:10px">
                <asp:Button ID="itembtn" runat="server" Text="Add Item" style="background-color:#36b9cc; color:white; width:120px; height:40px; font-weight:normal;border-radius:4px; font-size:20px; border:1px solid white; " onclick="itembtn_Click"/>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptcontent" runat="server">
    <script src="../stdfiles/datepicker%20(1).js"></script>
    <script src="../stdfiles/fileupload.js"></script>
    <script src="../stdfiles/Script%20(1).js"></script>
</asp:Content>

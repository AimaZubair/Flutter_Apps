...
<asp:Content ID="Content2" ContentPlaceHolderID="datacontent" runat="server">
    ...
    <div class="mainbox" style="width:60%; margin-left:20%; margin-right:20%; position:relative">
        ...
        <table style="width:100%;text-align:left">
            ...
            <td style="width:60%"><input id="phone" class="form-control" runat="server" style="width:280px; height:40px" type="tel" pattern="^\d{11}$" placeholder="03331111000" required/></td>
             </tr>
             <tr style="height:60px">
        ...
        <div style="width:100%; text-align:center; height:50px; margin-top:15px">
            <asp:Button ID="btnenter" runat="server" Text="Add Firm" style="background-color:#36b9cc; color:white; width:120px; height:40px; font-size:20px; font-weight:normal; border:1px solid white; border-radius:4px " onclick="btnenter_Click"/>
        </div>
    </div>
        </form>
</asp:Content>

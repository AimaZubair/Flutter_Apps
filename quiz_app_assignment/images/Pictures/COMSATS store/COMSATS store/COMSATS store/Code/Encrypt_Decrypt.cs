...
namespace COMSATS_store.Code
{
    public class Encrypt_Decrypt
    {
        public static string Encrypt(string plaintext)
        {
            ...
            int keySize = 256;   //decrypt text size will be 256
            byte[] initVectorBytes = Encoding.UTF8.GetBytes(initVector);  //get bytes of both variable
            ...
            // use this password to generates the psedo-random bytes for the encryption key.
            ...
            //close both stream memory or crypto stream

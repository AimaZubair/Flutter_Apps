...
namespace COMSATS_store.Employees
{
    public partial class addemployee : System.Web.UI.Page
    {
        ...
        protected void btnenter_Click(object sender, EventArgs e)
        {
            ...
            obj.EmployeeName = empname.Value;
            ...
            obj.EmployeeGender = gender.SelectedValue.ToString();
            obj.Employeephone = cell.Value;
            obj.EmployeeAccountType = Convert.ToInt32(accounttype.SelectedValue.ToString());
            string html = "";
            string path = "";
            string newfilename = "";
           // byte[] bytes = null;
